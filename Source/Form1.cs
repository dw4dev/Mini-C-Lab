...
namespace MiniCSharpLab
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            _titlePrefix = string.Format("Mini C# Lab Ver {0}.{1}.{2} - ",
        ...
        private void cbDotNetVersionList_SelectedIndexChanged(object sender, EventArgs e)
        {
            wfListItem li = cbDotNetVersionList.SelectedItem as wfListItem;
            SetupDotNetVersion(li.Value);
        }
